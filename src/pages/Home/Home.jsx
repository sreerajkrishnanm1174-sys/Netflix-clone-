...
function Home() {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      ...
      const popularData = [
        ...(await getPopularMovies(type1)),
        ...(await getPopularMovies(type2)),
      ]
        .sort(() => Math.random() - 0.5)
        .slice(0, 10);
      const topRatedData = [
        ...(await getTopRatedMovies(type1)),
        ...(await getTopRatedMovies(type2)),
      ].sort(() => Math.random() - 0.5);
    ...
    <>
      <div className="w-[100%] h-fit">
        ...
        <Containerdiv>
          ...
          <br />
          <h1 className="text-white text-4xl  ml-5">Tv series</h1>
          <br />
