  ...
  return (
    <div className="text-white overflow-hidden">
      ...
      <Containerdiv>
        <div className="p-10 grid md:grid-cols-2 gap-8">
          <div>
            ...
            <p>
              ...
              {!movie?.budget ? "Not disclosed" : `$ ${movie.budget}`}
            </p>
            <p>
              <span className="text-gray-400">Revenue:</span>{" "}
              {!movie?.revenue ? "Not disclosed" : `$ ${movie.revenue}`}
            </p>
            <p>
              <span className="text-gray-400">Runtime:</span> {movie.runtime}{" "}
              min
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {movie.genres?.map((g) => (
                <span key={g.id} className="bg-gray-800 px-3 py-1 rounded-full">
                  {g.name}
                </span>
              ))}
            </div>
        ...
        {/* TRAILER VIDEO */}
        {trailer && <Trailer id={trailer} className="h-[500px]" />}
        ...
        <Paginationdiv page={page} setPage={setPage} totalPages={totalPages} />
      </Containerdiv>
      <br />
      <br />
      <br />
